...
{
	print("\n--------------------------------------");
	print(" Text Draw Editor 1.0 by Zamaroht for SA-MP 0.3 Loaded.");
	print("--------------------------------------\n");
	AddPlayerClass(0,1364.7202,709.8582,10.8203,270,0,0,0,0,0,0);
...
stock UpdateTextdraw( tdid )
{
	...
	if(tData[tdid][T_PreviewModel])
	{
		...
		if(400 >= tData[tdid][T_PreviewModel] <= 611) TextDrawSetPreviewVehCol(tData[tdid][T_Handler], 0,0);
	}
